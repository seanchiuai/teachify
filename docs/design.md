...
├────────────────────────────────────────────────────────────────────┤
│                                                                    │
│  Why can't a cell survive if its mitochondria                      │
│  stop functioning?                                                 │
│                                                                    │
│  ┌─────────────────────────────┐ ┌─────────────────────────────┐  │
│  │ A) No DNA replication       │ │ B) No ATP production        │  │
│  └─────────────────────────────┘ └─────────────────────────────┘  │
│  ┌─────────────────────────────┐ ┌─────────────────────────────┐  │
│  │ C) No protein synthesis     │ │ D) No cell division         │  │
│  └─────────────────────────────┘ └─────────────────────────────┘  │
│                                                                    │
│  ── After Answer ──                                                │
│  ✅ Correct! +850 pts                                              │
│  Mitochondria produce ATP, the cell's energy currency.             │
│  Without ATP, cellular processes cannot function.                  │
│                                                                    │
│  ── Leaderboard ──                                                 │
│  🥇 Maya    4,200                                                  │
│  🥈 Alex    3,850                                                  │
...
└── Router
    ...
    └── /play/[code] → StudentGameView
        ...
        ├── OrderingQuestion (drag reorder)
        ├── CategorizationQuestion (sort into groups)
...
### Loading States
- "Generate Game" button shows spinner + "Generating questions..." text
